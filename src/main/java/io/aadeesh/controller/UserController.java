...
public class UserController 
{
	...
	public ModelAndView addUser(@RequestParam("user_email") String user_email, User user)
	{
		...
		else
		{
			...
			user.setUser_pass(encryptor.encryptPassword(user.getUser_pass()));
			...
			HttpSession session,ModelMap modelMap)
	{
		...
		User auser=urepo.findByEmail(username);
	if(auser!=null)
	{
		if(encryptor.checkPassword(password,auser.getUser_pass()))
		{
